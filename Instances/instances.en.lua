...
AtlasLoot_Data["AtlasLootItems"] = {
	...
	ZGTrash2 = {
		...
		{ 19707, "INV_Bijou_Red", "=q3=Red aHakkari Bijou", "=ds=#m39#", "1.63%" },
 ...
 ZGEnchants = {
	...
	STBalconyMinibosses = {
		{ 10783, "INV_Shoulder_18", "=q3=Atal'ai Spaulders", "=ds=#s3#, #a2# =q2=#e32#", "6.6%" },
		{ 10784, "INV_Chest_Chain_05", "=q3=Atal'ai Breastplate", "=ds=#s5#, #a3# =q2=#e32#", "6.6%" },
		{ 10787, "INV_Bracer_18", "=q3=Atal'ai Gloves", "=ds=#s9#, #a1# =q2=#e32#", "6.6%" },
		{ 0, "", "", "" },
		{ 10788, "INV_Belt_15", "=q2=Atal'ai Girdle", "=ds=#s10#, #a4# =q2=#e32#", "6.6%" },
		{ 10785, "INV_Pants_07", "=q2=Atal'ai Leggings", "=ds=#s11#, #a2# =q2=#e32#", "6.6%" },
		{ 10786, "INV_Boots_01", "=q2=Atal'ai Boots", "=ds=#s12#, #a3# =q2=#e32#", "6.6%" },
		{ 0, "", "", "" },
	...
	STAvatarofHakkar = {
		...
		{ 0, "", "", "" },
		{ 10843, "INV_Misc_Cape_05", "=q3=Featherskin Cape", "=ds=#s4#", "16.6%" },
		{ 10845, "INV_Chest_Plate08", "=q3=Warrior's Embrace", "=ds=#s5#, #a4#", "16.6%" },
		{ 10842, "INV_Pants_14", "=q3=Windscale Sarong", "=ds=#s11#, #a2#", "16.6%" },
		{ 10846, "INV_Boots_01", "=q3=Bloodshot Greaves", "=ds=#s12#, #a3#", "16.6%" },
		{ 10838, "INV_Mace_11", "=q3=Might of Hakkar", "=ds=#h3#, #w6#", "16.6%" },
		{ 10844, "INV_Staff_32", "=q3=Spire of Hakkar", "=ds=#w9#", "16.6%" },
		{ 0, "", "", "" },
		{ 51217, "INV_misc_ribbon_01", "=q2=Fashion Coin", "=ds=#e27#", "5%" },
	};
	STJammalan = {
	...
	STEranikus = {
		...
		{ 0,"","","" },
		{ 10833, "INV_Helmet_25", "=q3=Horns of Eranikus", "=ds=#s1#, #a3#", "16.6%" },
		{ 10829, "INV_Jewelry_Amulet_04", "=q3=Dragon's Eye", "=ds=#s2#", "16.6%" },
		{ 10836, "INV_Wand_04", "=q3=Rod of Corrosion", "=ds=#w12#", "16.6%" },
		{ 10835, "INV_Shield_04", "=q3=Crest of Supremacy", "=ds=#w8#", "16.6%" },
		{ 10837, "INV_Axe_07", "=q3=Tooth of Eranikus", "=ds=#h3#, #w1#", "16.6%" },
		{ 10828, "INV_Weapon_ShortBlade_16", "=q3=Dire Nail", "=ds=#h1#, #w4# =q2=#e31#", "16.6%" },
		{ 0,"","","" },
	...
	DMWTendrisWarpwood = {
		...
		{ 70054, "inv_boots_plate_05", "=q3=Wyrmheart Boots", "=ds=#s12#, #a4#, Currently off the Loot Table", "6%" },
		{ 0, "", "", "" },
	...
	DMWIllyannaRavenoak = {
		...
		{ 70053, "inv_pants_04", "=q3=Rotworm Legplates", "=ds=#s11#, #a4#, Currently off the Loot Table", "6%" },
		{ 0, "", "", "" },
	...
	DMWMagisterKalendris = {
		...
		{ 70051, "inv_gauntlets_09", "=q3=Gauntlets of Wrangling", "=ds=#s9#, #a4#, Currently off the Loot Table", "6%" },
		{ 0, "", "", "" },
	...
	DMWImmolthar = {
		...
		{ 70050, "inv_shoulder_11", "=q3=Shoulderplates of Misfortune", "=ds=#s3#, #a4#, Currently off the Loot table", "6%" },
		{ 70055, "inv_chest_plate08", "=q3=Breastplate of Forgotten Valor", "=ds=#s5#, #a4#, Currently off the Loot table", "6%" },
		{ 0, "", "", "" },
		{ 51217, "INV_misc_ribbon_01", "=q2=Fashion Coin", "=ds=#e27#", "5%" },
	};
	DMWHelnurath = {
		...
		{ 70052, "inv_belt_13", "=q3=Skorgrim's Lost Belt", "=ds=#s10#, #a4#, Currently off the Loot table", "6%" },
	};
	DMWPrinceTortheldrin = {
		...
		{ 70056, "inv_helmet_25", "=q3=Horned Helm of Ancient Kings", "=ds=#s1#, #a4#, Currently off the Loot table", "6%" },
		{ 0, "", "", "" },
		{ 51217, "INV_misc_ribbon_01", "=q2=Fashion Coin", "=ds=#e27#", "100%" },
	};
	DMWShendralarProvisioner =		{ 
	...
	STRATSkull = {
		...
		{ 70060, "inv_pants_04", "=q3=Greaves of Servitude", "=ds=#s11#, #a4#, Currently off the Loot Table", "6%" },
	};
	STRATStratholmeCourier={
	...
	STRATTheUnforgiven = {
		...
		{ 70064, "inv_shoulder_11", "=q3=Epaulets of Courage", "=ds=#s3#, #a4#, Currently off the Loot Table", "6%" },
	};
	STRATTimmytheCruel = {
	...
	STRATArchivistGalford = {
		...
		{ 70062, "inv_gauntlets_09", "=q3=Gauntlets of Force", "=ds=#s9#, #a4#, Currently off the Loot Table", "6%" },
		{ 0, "", "", "", "" },
	...
	STRATMagistrateBarthilas = {
		...
		{ 70059, "inv_boots_plate_05", "=q3=Sabatons of Protection", "=ds=#s12#, #a4#, Currently off the Loot Table", "6%" },
